                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="topbar-left col-sm-3 col-xs-4">
                            <a href="index.html" class="logo"> <img src="assets/images/logo.png" alt="" class="img-responsive"> </a>
                        </div>
                        <!-- End Logo container-->
                        <div class="menu-extras col-sm-9 col-xs-8">
                            <ul class="nav navbar-nav navbar-right pull-right">
                                <li>
                                    <form role="search" class="app-search pull-left hidden-xs">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Search coupons ..." aria-label="Text input with multiple buttons"> </div> <a href=""><i class="ti-search"></i></a> </form>
                                </li>
                                ...
                                <li class="dropdown user-box"> <a href="" class="dropdown-toggle profile btn btn-default" data-toggle="dropdown" aria-expanded="true">
                              My account
                              </a>
                ...
                <div class="container">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu"> <a href="#"><i class="ti-cut"></i> <span> Coupons </span> </a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"> <a href="#"><i class="ti-announcement"></i> <span> Stores </span> </a>
                                <ul class="submenu">
                                    <li><a href="store_profile.php">Store</a> </li>
                                    <li><a href="categories.html">Store categories</a> </li>
                                </ul>
                            </li>
                            <li class="has-submenu"> <a href="#"><i class="ti-layout-list-thumb"></i> <span> Pages </span> </a>
                                <ul class="submenu">
                                    <li><a href="store_profile.php">Store</a> </li>
                                    ...
                                    <li><a href="blog_articlesX.php">Blog list</a> </li>
                                </ul>
                            </li>
                        </ul>
                        <!-- End navigation menu  -->
        ...
        <div class="breadcrmb-wrap hidden-xs">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6"> <a href="submit.html" role="button" class="btn btn-border pull-right">
                     Submit coupon
                     </a> </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 blog">
                        <div class="widget">
                            <div class="widget-body">
                                <a href="#" class="img-caption"> <img src="http://placehold.it/980x400" class="img-responsive" alt=""> <span>Codenpixel /</span> Building your business with Kuponhub</a>
                                <h3>Get <span>down get</span> down fo shizzle mah fo rizzle</h3>
                                <ul class="post-meta">
                                    <li><i class="ti-time"></i> March 21,2016 10:11 PM</li>
                                    <li><i class="ti-heart"></i> 5472</li>
                                    <li><i class="ti-comments"></i> 43</li>
                                </ul>
                            </div>
                        </div>
                        <!-- end: Blog widget -->
